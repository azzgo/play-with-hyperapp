...
window.history.pushState = Function.prototype;
hyperapp_1.app({
    state: "Hi.",
    view: {
        "/": function (state) { return hyperapp_1.h("div", { onClick: true }, "Home"); },
        "/err": function (state) { return hyperapp_1.h("div", { onClick: true }, "Home"); }
    },
